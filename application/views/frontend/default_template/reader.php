...
echo(implode('/', $jalali_date). ' در ساعت ' . $date_array['3'] .':'.$date_array['4']);
				...
				<ul>
					...
					<?php $user = $this->users_model->get_users_by_id($comment_replay->comment_user_id); ?>
...
echo(implode('/', $jalali_date). ' در ساعت ' . $date_array['3'] .':'.$date_array['4']);
						 ?>
										...
										<a class="alert_link alert_link_comments" data-type='comment' data-type-id="<?=$comment_replay->id?>" href="#alert_modal"  rel="modal:open">
											<i class="fas fa-exclamation-triangle"></i>گزارش
										</a>
								</span>
								</p>
