{header}
	...
	<section id="wrapper">
		<!-- Title -->
		<div class="section_title white news_title"><span>تازه ها</span><a href="<?=base_url('all')?>">مشاهده همه</a></div>
		...
		<ul class="articles grid-6_md-4_sm-3_xs-2">
			...
			<?php endif; ?>
				<div class="article_image">
					<img src="./public/img/post_images/<?=$article->post_image?>" alt="">
				</div>
				<div class="article_image_placeholder" style="background-image: url('./public/img/post_images/<?=$article->post_image?>')"></div>
				<div class="article_description_placeholder">
					<p class="article_description_content">
						<?= substr($article->description, 0, 140) ?>...
						<div class="article_options">
							<span href="#" class="article_more_options">
								<i class="fas fa-ellipsis-h"></i>
								بیشتر
								<ul class="article_more_options_menu">
									<li>
										<a href="#" class="like" data-article_id='<?=$article->id?>'>
											<span class="hidden"><?=count($this->post_model->get_likes($article->id))?></span>
											<i class="fas fa-bookmark"></i>ذخیره</li>
										</a>
									<li>
										<a class="alert_link" data-type='article' data-type-id="<?=$article->id?>" href="#alert_modal"  rel="modal:open">
		...
		<!-- Title -->
		<div class="section_title white popular_title"	><span>پر طرفدار ها</span><a href="<?=base_url('all/popular')?>">مشاهده همه</a></div>
