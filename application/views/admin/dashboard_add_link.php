                                    ...
                                    <form class="col s12" id="upload_form"> 
                                        ...
                                        <div class="input-field col s12 m12 right">
                                            ...
                                            <select name="parent_id">
                                                <option selected value="0">مادر (اصلی)</option>
                                                {parent_links}
                                        ...
                                        <div class="input-field col s12 m12 right">
                                            ...
                                            <select name="position">
                                                <option selected value="top">هدر (بالا)</option>
                                                <option value="bottom">فوتر (پایین)</option>
                                            </select>
                                        </div>
                                        <div class="input-field col s12 m12 right">
                                        ...
                                        <div class="input-field col s12 m12 right">
                                            <i class="material-icons prefix">mode_edit</i>
                                            <input name="icon" id="icon_prefix" type="text" placeholder="آیکون سفارشی" class="validate">
                                        </div>                                        
                                        <div class="input-field col s12 m12 right">
                                            <i class="material-icons prefix">mode_edit</i>
                                            <input name="address" id="icon_prefix" type="text" placeholder="آدرس" class="validate">
                                        </div>
...
$(document).ready(function(){
    ...
    $('#upload_form').submit(function(e){
        ...
        $.ajax({
            url: "<?=base_url()?>dashboard/create_link/",
            type: 'post',
            data: form_data,
            processData: false,
            contentType: false,
