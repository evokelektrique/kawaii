                ...
                <div class="col m7 s12">
                    <div class="card">
                        <div class="card-image">
                            ...
                            <span class="card-title">ویرایش دسته</span>
                        </div>
                                ...
                                {category}
                                    ...
                                    <form class="col s12" id="upload_form"> 
                                        ...
                                        <div class="input-field col s12 m12 right">
                                            ...
                                            <input value="{cat_name}" name="cat_name" id="icon_prefix" type="text" placeholder="اسم دسته" class="validate">
                                        </div>
...
$(document).ready(function(){
    ...
    $('#upload_form').submit(function(e){
        ...
        e.preventDefault();
        $.ajax({
            url: "<?=base_url()?>dashboard/do_edit_category/<?=$category[0]->cat_id?>",
            type: 'post',
            data: form_data,
            processData: false,
            contentType: false,
