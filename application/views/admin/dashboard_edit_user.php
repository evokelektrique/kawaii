                ...
                <div class="col m7 s12">
                    <div class="card">
                        <div class="card-content black-text upload_form">
                            <span class="card-title white-text">ویرایش کاربر</span>
                                ...
                                {user}
                                    ...
                                    <form class="col s12" id="upload_form"> 
                                        ...
                                        <div class="input-field col s12 m6 right">
                                            ...
                                            <input value="{username}" name="username" id="icon_prefix" type="text" placeholder="نام کاربری" class="validate">
                                        </div>
                                        <div class="input-field col s12 m6 right">
                                            <i class="material-icons prefix">mode_edit</i>
                                            <input value="{email}" name="email" id="icon_prefix" type="text" placeholder="ایمیل" class="validate">
                                        </div>
                                        <div class="input-field col s12 m6 right">
                                            <i class="material-icons prefix">mode_edit</i>
                                        ...
                                        <div class="input-field col s12 m6 right">
                                            <i class="material-icons prefix">mode_edit</i>
                                            <input value="{firstname}" name="firstname" id="icon_prefix" type="text" placeholder="نام" class="validate">
                                        </div>
                                        <div class="input-field col s12 m6 right">
                                            <i class="material-icons prefix">mode_edit</i>
                                            <input value="{lastname}" name="lastname" id="icon_prefix" type="text" placeholder="نام خانوادگی" class="validate">
                                        </div>
                                        <div class="input-field col s12 m6 right">
                                            <select name="role">
                                                <option value="" disabled>نقش کاربر</option>
                                                <option <?php echo ($user[0]->role == 1) ? "selected" : "" ?> value="1">کاربر معمولی</option>
                                                <option <?php echo ($user[0]->role == 2) ? "selected" : "" ?> value="2">کاربر مدیر</option>
                                                <option <?php echo ($user[0]->role == 3) ? "selected" : "" ?> value="3">کاربر مسدود</option>
                                            </select>
                                        </div>
                                        <div class="file-field col s12 m12 right">
                                            <div class="btn right blue waves-effect waves-light lighten-1">
                                                ...
                                                <input type="file" value="{profile_picture_url}" name="profile_picture">
                                            </div>
                                            <div class="file-path-wrapper">
                                                <input class="file-path validate" name="profile_picture_url" value="{profile_picture_url}" type="text">
                                            </div>
                                        </div>
                                        <div class="file-field col s12 m12 right">
                                            <div class="btn right blue waves-effect waves-light lighten-1">
                                                <span>انتخاب عکس پس زمینه</span>
                                                <input type="file" value="{profile_cover_url}" name="profile_cover">
                                            </div>
                                            <div class="file-path-wrapper">
                                                <input class="file-path validate" name="profile_cover_url" value="{profile_cover_url}" type="text">
                                            </div>
                                        </div>
...
$(document).ready(function(){
    ...
    $('#upload_form').submit(function(e){
        ...
        e.preventDefault();
        $.ajax({
            url: "<?=base_url()?>dashboard/do_edit_user/<?=$user[0]->id?>",
            type: 'post',
            data: form_data,
            processData: false,
            contentType: false,
