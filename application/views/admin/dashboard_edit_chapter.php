                ...
                <div class="col m7 s12">
                    <div class="card">
                        <div class="card-image">
                            ...
                            <span class="card-title">ویرایش فصل</span>
                        </div>
                                ...
                                {chapter}
                                    ...
                                    <form class="col s12" id="upload_form"> 
                                        ...
                                        <div class="input-field col s12 m6 right">
                                            ...
                                            <input value="{name}" name="name" id="icon_prefix" type="text" placeholder="اسم فصل" class="validate">
                                        </div>

                                        <div class="input-field col s12 m6 right">
                                            <select name="status">
                                                <option value="" disabled selected>وضعیت فصل</option>
                                                <option <?php echo ($chapter[0]->status == 1) ? "selected" : "" ?> value="1">فعال</option>
                                                <option <?php echo ($chapter[0]->status == 2) ? "selected" : "" ?> value="2">غیر فعال</option>
                                            </select>
                                        </div>
...
$(document).ready(function(){
    ...
    $('#upload_form').submit(function(e){
        ...
        e.preventDefault();
        $.ajax({
            url: "<?=base_url()?>dashboard/do_edit_chapter/<?=$chapter[0]->id?>",
            type: 'post',
            data: form_data,
            processData: false,
            contentType: false,
